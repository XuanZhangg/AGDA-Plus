...
b=1
for mu_y in [1]:
    for kappa in [5,10,20,50,100,1000,10000]: # 5,10,20,50,100, 5,10,20,50,100,1000,
        model_type = 'Q' # Q: projection_y=False,DRO,FairCNN: projection_y=True
        sim_time = 10
        max_iter = 30000
        
        SGDA_B_ITER = {5:3e4,10:3e4,20:3e4,50:3e4,100:3e4,1000:1e4,10000:20000}
        max_iter_SGDA_B = SGDA_B_ITER[kappa]
